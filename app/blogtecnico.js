  ...
  const articulosBlog = [
    {
      ...
      extracto: "En la era digital actual, los contact centers están experimentando una revolución tecnológica sin precedentes. La inteligencia artificial (IA) se ha convertido en el motor principal de esta transformación, redefiniendo la forma en que las empresas interactúan con sus clientes.",
      contenidoCompleto: `
# Introducción
